...
public class ReporteTokens extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ReporteHTML
     *
     * @param listaTokens
     */
    public ReporteTokens(List<Token> listaTokens) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("REPORTE DE TOKENS ENCONTRADOS");
    ...
    private void btnGenerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarActionPerformed
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            generar.reporteTokens(listaTokens, directoryPath, fileName);
            if (generar.isGenerado()) {
                JOptionPane.showMessageDialog(null, "REPORTE GENERADO", "SUCCES", JOptionPane.INFORMATION_MESSAGE);
            } else {
